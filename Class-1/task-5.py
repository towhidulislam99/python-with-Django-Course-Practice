...
Total_Profit_Black = TotalDiscountPrice_Black_Sell - Total_cost_Black_Purchase 
Total_Profit_Vanila = TotalDiscountPrice_Vanila_Sell - Total_cost_vanila_Purchase  
Total_Profit_Red = TotalDiscountPrice_Red_Sell - Total_cost_red_Purchase  
Total_Profit_Lemon = TotalDiscountPrice_Lemon_Sell - Total_cost_lemon_Purchase 
Total_Profit_Chocolate = TotalDiscountPrice_Chocolate_Sell - Total_cost_chocolate_Purchase  

TotalamountofProfit_Sell = Total_Profit_Black + Total_Profit_Vanila + Total_Profit_Red + Total_Profit_Lemon + Total_Profit_Chocolate
